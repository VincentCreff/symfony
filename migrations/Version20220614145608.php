 ...
 */
final class Version20220614145608 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cart_item (id INT AUTO_INCREMENT NOT NULL, product_id INT DEFAULT NULL, shopping_cart_id INT DEFAULT NULL, quantity INT DEFAULT NULL, INDEX IDX_F0FE25274584665A (product_id), INDEX IDX_F0FE252745F80CD (shopping_cart_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
